...
3. ### Firebase Dynamic Links
   داینامیک لینک‌ها این امکان رو به شما میدن تا بتونید لینک‌های هوشمند بسازید که در مواقع مختلف رفتار متفاوتی از خودشون نشون بدن. برای مثال شما در وبسایتتون یک محصول برای فروش گذاشتید، کاربر بعد از کلیک روی اون لینک (اگر سایت رو در موبایلش باز کرده باشه و بر اساس پلتفرم سیستم عاملش) به سمت اون صفحه از اپلیکیشن هدایت میشه که و محصول بهش نشون داده یا همونجا فاکتور برای پرداخت براش صادر میشه تا خریدش رو سریعتر انجام بده. (بیشتر بدانید: [متن](https://firebase.google.com/docs/dynamic-links/) - [ویدئو](https://www.youtube.com/watch?v=LvY1JMcrPF8) )
