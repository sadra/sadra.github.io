...
6. ### Adwords
   جالب اینجاست که گوگل سرویس Adwordsش رو هم به فایربیس انتقال داده و شما می‌تونید با استفاده از این سرویس مثل سابق کاربران مورد نظرتون رو هدف قرار داده و نتیجه رو در **Firebase Analytics** مشاهده کنید.  (بیشتر بدانید: [متن](https://firebase.google.com/docs/adwords/) -‌ [ویدئو](https://youtu.be/YTgJjKU9GdQ) )
...
3. ### GeoFire
  جئوفایر هم بهمون کمک میکنه تا با استفاده از Firebase Databse بتونیم اطلاعات لوکیشن و جئومتریک کاربران اپلیکیشن رو در پایگاه داده آنلاین‌مون ذخیره کرده و نگهداری کنیم. (و احتمالا بعدا ازش استفاده کنیم 😈) ([وبسایت](https://github.com/firebase/geofire))
