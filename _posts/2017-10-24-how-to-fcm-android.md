...
```
 ...
 حالا اگه بخواییم پیام برای همه کاربرا ارسال بشه چی؟ آیا باید توکن همه کابرارو لیست کنیم و بفرستیم؟ نه، نیازی به اینکار نیست! چون همه کاربرها بطور پیشفرض همون ابتدا عضو تاپیک `global` هستند، یعنی اگه قرار بود پیام برای همه ارسال بشه فقط کافیه بگید که:
