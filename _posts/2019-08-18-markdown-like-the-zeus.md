...
ازتون می‌خوام اگه فکر می‌کنید من حقه‌ي خاصی استفاده می‌کنم یا توی ترتیب شماره‌ها دستکاری کردم، برید و فایل md همین پست رو ببینید. تنها چیزی که برای مارکداون مهمه اینه که آیتم اول حتما از **«یک»** شروع شده باشه.
